...
public class Day3 {
    ...
    public Map<Point, Integer> runWire(List<String> wire) {
        ...
        for (String instruction : wire) {
            ...
            // Loop for the amount specified by moveAmount
            for (int i = 0; i < moveAmount; i++) {
                // Move in that direction by 1 point
