...
public class Day2Test {
    ...
    public void testOptcode1LargeSample() {
        assertEquals(70, d2.runOpcode(intInput)[3]);
    }
    ...
    public void testOptcode1SmallSample() {
        ...
        intInput = f.toIntArray(stringInput, ",");
        assertEquals(2, d2.runOpcode(intInput)[0]);
    }
    ...
    public void testOptcode2SmallSample() {
        ...
        intInput = f.toIntArray(stringInput, ",");
        assertEquals(6, d2.runOpcode(intInput)[3]);
    }
    ...
    public void testOptcode99SmallSample() {
        ...
        intInput = f.toIntArray(stringInput, ",");
        assertEquals(9801, d2.runOpcode(intInput)[5]);
    }
    ...
    @Test
    public void testFindingNounAndVerb() {
        int expectedResult = 19690720;
        int[] actualResult = d2.findVerbAndNoun();
